...
namespace TYPO3\CMS\v95\Core\Upgrades;

use TYPO3\CMS\Core\Upgrades\AbstractDownloadExtensionUpdate;
use TYPO3\CMS\Core\Upgrades\Confirmation;
use TYPO3\CMS\Core\Upgrades\ExtensionModel;
 ...
 */
#[UpgradeWizard('adminpanelExtension')]
class AdminPanelInstall extends AbstractDownloadExtensionUpdate
{

    /**
     * @var \TYPO3\CMS\Core\Upgrades\Confirmation
     */
     ...
     *
     * @return \TYPO3\CMS\Core\Upgrades\Confirmation
     */
